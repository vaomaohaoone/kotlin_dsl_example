package kotlin_dsl.kotlin_dsl

fun selectQuery(init: SqlSelectBuilder.() -> Unit): SqlSelectBuilder {
    ...
    fun select(vararg columns: String) {
        ...
        if (this.columns.isNotEmpty()) {
            throw IllegalStateException(
                "Detected an attempt to re-define columns to fetch. Current columns list: "
...
@DslMarker
annotation class ConditionMarker